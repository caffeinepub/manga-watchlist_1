...
import type { MangaEntry as _MangaEntry, MangaEntryInput as _MangaEntryInput, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addEntry(arg0: MangaEntryInput): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addEntry(to_candid_MangaEntryInput_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEntry(arg0: bigint): Promise<MangaEntry | null> {
        if (this.processError) {
            try {
    ...
    async isUnlocked(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isUnlocked();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetAttempts(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetAttempts(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateEntry(arg0: bigint, arg1: MangaEntryInput): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateEntry(arg0, to_candid_MangaEntryInput_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_MangaEntry_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MangaEntry): MangaEntry {
...
function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MangaEntry]): MangaEntry | null {
    return value.length === 0 ? null : from_candid_MangaEntry_n17(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        coverImageKey: record_opt_to_undefined(from_candid_opt_n20(_uploadFile, _downloadFile, value.coverImageKey)),
        chaptersOwned: value.chaptersOwned,
        mainTitle: value.mainTitle,
        artRating: value.artRating,
        altTitle: value.altTitle,
        chaptersRead: value.chaptersRead,
        createdAt: value.createdAt,
        updatedAt: value.updatedAt,
        cenLevel: value.cenLevel,
...
function from_candid_variant_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    Incomplete: null;
}): Variant_Complete_Incomplete {
    return "Complete" in value ? Variant_Complete_Incomplete.Complete : "Incomplete" in value ? Variant_Complete_Incomplete.Incomplete : value;
}
...
function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MangaEntry>): Array<MangaEntry> {
    return value.map((x)=>from_candid_MangaEntry_n17(_uploadFile, _downloadFile, x));
}
function to_candid_MangaEntryInput_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MangaEntryInput): _MangaEntryInput {
...
function to_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        coverImageKey: value.coverImageKey ? candid_some(value.coverImageKey) : candid_none(),
        chaptersOwned: value.chaptersOwned,
        mainTitle: value.mainTitle,
        artRating: value.artRating,
        altTitle: value.altTitle,
...
function to_candid_variant_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_Complete_Incomplete): {
    Complete: null;
} | {
    Incomplete: null;
} {
    return value == Variant_Complete_Incomplete.Complete ? {
        Complete: null
    } : value == Variant_Complete_Incomplete.Incomplete ? {
        Incomplete: null
    } : value;
}
